...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-reteica-2.php" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Nombre del tipo de retención" value="" onChange="javascript:this.value=this.value.toUpperCase();">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Valor" id="Valor" class="form-control" placeholder="Porcentaje de la retención %" onkeypress="return isNumberKey(event, this);">
																</div>
															</div>
														</div>
													</div>
