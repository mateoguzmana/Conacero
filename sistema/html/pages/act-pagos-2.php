...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$decimale 	= explode(".",$Valor);
					$CuantosX	= $decimale[1];
					$CuantosDX	= strlen($CuantosX);
					...
					$decimalez 	= explode(".",$Deuda);
					$CuantosXz	= $decimalez[1];
					$CuantosDXz	= strlen($CuantosXz);
...
?>
												...
												<div class="col-sm-12">
													...
													<div class="col-md-10">
													<input type="text" name="Valor" <?=$ponebloqueo?> id="Valor" value="<?=$Valorx?>" class="form-control dollar-mask" required>
														...
														<div class="col-sm-6">
                                                            <div class="form-group">
																...
																<label class="control-label">Saldo</label>
																			...
																			<div class="col-md-10">
																			<input type="text" readonly value="<?=$Deudax?>" class="form-control dollar-mask" required>
																</div>
																</div>
																</div>	
													</div>
