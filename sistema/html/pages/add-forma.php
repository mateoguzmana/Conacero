								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Crear Forma de Pago</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-forma-2.php" novalidate>
                                                        <?
														}
														else
														{
