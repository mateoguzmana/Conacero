								...
								$MosPerz2	=	1;
												...
												<tr class="gradeA">
													...
													<td class="text-right">
														...
														{
														?>
														<input name="Procesar" type="button" class="btn btn-danger" value="ANULADA"  style="width:100px;" onClick="window.open('print-abonocobro.php?Id=<?=$Idextra?>&Idpago=<?=$Idpago?>&Idcliente=<?=$IdclienteUSERS?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>','_blank')"> 
                                                        <?
														}
														?>
                                                        <? /*
