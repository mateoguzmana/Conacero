													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Razón Social/Nombre" value="" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Cedula" id="Cedula" class="form-control" placeholder="Nit/Cédula" value=""  required>
																</div>
															</div>
														</div>
