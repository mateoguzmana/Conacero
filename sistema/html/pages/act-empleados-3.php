...
$queryka			="UPDATE Empleados set Nombre = '$Nombre', Cedula = '$Cedula', Ciudad = '$Ciudad', Dir = '$Dir', Telefono = '$Telefono', 
Celular = '$Celular', Contacto = '$Contacto', Celcontacto = '$Celcontacto', Email = '$Email', Retencion = '$Retencion',
