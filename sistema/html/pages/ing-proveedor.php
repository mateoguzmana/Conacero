													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Cedula" id="Cedula" class="form-control" placeholder="Nit" value="" onKeyPress="return isNumberKey(event);" required data-rule-minlength="4">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
													...
													<div class="row">	
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="NumeroCuenta" id="NumeroCuenta" class="form-control" placeholder="Numero de cuenta">
																</div>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Titular" id="Titular" class="form-control" placeholder="Titular de la cuenta" onChange="javascript:this.value=this.value.toUpperCase();" data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Identificacion" id="Identificacion" class="form-control" placeholder="Cedula">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="password" name="Contrasena" id="Contrasena" class="form-control" placeholder="Contraseña" data-rule-minlength="6">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="password" name="Contrasena1" id="Contrasena1" class="form-control" placeholder="Repita la Contraseña"  data-rule-equalto="#Contrasena" data-rule-minlength="6">
																</div>
															</div>
														</div>
													</div>
