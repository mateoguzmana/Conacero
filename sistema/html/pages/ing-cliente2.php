...
{
$sql="INSERT INTO  Clientes (Nombre, Cedula, Ciudad, Dir, Telefono, Celular, Contacto, Celcontacto, Email, Retencion, Contrasena, TipoCuenta, NumeroCuenta, Titular, Identificacion, FormaPago, Banco)";
$sql.= "VALUES ('$Nombre','$Cedula','$Ciudad','$Dir','$Telefono','$Celular','$Contacto','$Celcontacto','$Email','$Retencion','$Contrasena','$TipoCuenta','$NumeroCuenta','$Titular','$Identificacion','$FormaPago','$Banco')";
mysql_query($sql);
