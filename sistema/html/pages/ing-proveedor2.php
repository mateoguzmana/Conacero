...
{
$sql="INSERT INTO  Proveedores (Nombre, Cedula, Ciudad, Dir, Telefono, Celular, Contacto, Celcontacto, Email, Retencion, Contrasena, TipoCuenta, NumeroCuenta, Titular, Identificacion, FormaPago, Banco)
VALUES ('$Nombre','$Cedula','$Ciudad','$Dir','$Telefono','$Celular','$Contacto','$Celcontacto','$Email','$Retencion','$Contrasena','$TipoCuenta','$NumeroCuenta','$Titular','$Identificacion','$FormaPago','$Banco')";
mysql_query($sql,$id);
