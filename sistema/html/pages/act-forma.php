						...
						<div class="row">
							...
							$MosPerzB			=$rowPerz1["Del"];
								...
								$MosPerz2	=	1;
                                                ...
                                                $cont				=0;
												$queryUSERS			="SELECT* FROM Formas where Muestra = 0 Order by Nombre";
...
if (agree) 
{
location.href='forma-eliminar.php?Id=<?=$IdUSERS?>&Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>';	
return true ; 
}
else 
return false ; 
...
//-->
												...
												<tr class="gradeA">
													...
													<td class="text-right">
														...
														{
														?>                                                    
<input name="Procesar" type="button" class="btn btn-primary" value="MODIFICAR"  onClick="location.href='act-forma-2.php?Id=<?=$IdUSERS?>&Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>'"> 
                                                        <?
														}
														?> 
