...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$queryFF   			="SELECT * FROM CuentasPagar WHERE NumeroFactura='$Id'";
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Actualizar Acta de obra</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
                                                ...
                                                <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione un proveedor" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="act-actaobra-2.php?Id=<?=$Id?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$NombreProve?></option>
                                                                        <?
																		}
																		else
																		{
                                                                        ...
                                                                        ?>
                                                                        <option value="act-actaobra-2.php?Id=<?=$Id?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$Nombreproveedor?></option>
																		<?
																		}
																		}
																		}else{
															...
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC">
                                                                  ...
                                                                  <option value="act-actaobra-2.php?Idobra=<?=$Idobra?>&IdProve=<?=$Idproveedor?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreobra?></option>
                                                                        ...
                                                                        ?>
                                                                        <option value="act-actaobra-2.php?Idobra=<?=$IdTIP?>&IdProve=<?=$Proveedor?>&Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		}
																		?>
...
<div id="contenedor">
<?		  $query888="SELECT * FROM Movacta WHERE Idacta='$Id' ORDER BY Id";
    ...
    <?}?>
													...
													<div class="form-group">
														...
														<?if($Estado!=3){?>
														<input name="Eliminar" type="button" class="btn btn-danger" value="Finalizar" data-toggle="modal" data-target="#textModal<?=$Id?>" data-placement="top">
														<?}?>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title" id="textModalLabel">Finalizar acta obra nro. <?=$Id?></h4>
                                                            </div>
                                                            <div class="modal-body">
                                                            	<div class="alert alert-warning">¿Realmente desea finalizar esta acta? al finalizar se convertirá en una <strong>cuenta por pagar.</strong></div>
                                                            	<form action="fin-actaobra.php?Id=<?=$Id?>" method="post">
                                                            	<div class="row">
                                                            	<div class="col-sm-6">
																	<label for="FechaFin" class="control-label">Fecha vencimiento</label>
